...
2.  **Análise de Risco:** O DPO Ricardo Esper analisa as respostas do formulário, classificando o fornecedor como Risco Alto (acesso a biometria/código), Médio (acesso a logs de negócio) ou Baixo (acesso administrativo geral).
