...
| **A.66** | A.6.6 Acordos de Confidencialidade e Não Divulgação (NDAs) | `Implemented` | 4 | CISO | Assinatura obrigatória de NDA de admissão com validade de 5 anos.... (Aprovado por CEO Kacio Lopes) — ENG-2026-001: EVITERMOS/EVIPRO04 (Termos de sigilo/responsabilidade, 100% dos colaboradores) |
